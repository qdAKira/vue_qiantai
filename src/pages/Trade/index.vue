...
export default {
  ...
  computed: {
    ...
    // 提交订单，最终选择的地址
    userDefaultAddress() {
      // find：查找数组中符合条件的元素返回，初始没有的话，返回空对象
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      let data = {
        ...
        consigneeTel:this.userDefaultAddress.fullAddress,
        deliveryAddress:this.userDefaultAddress.phoneNum,
        paymentWay: "ONLINE", //支付方式
        orderComment: this.msg,
        orderDetailList: this.orderInfo.detailArrayList
      };

      let reslut = await this.$API.reqSubmitInfo(tradeNo, data);
      if(reslut.code == 200){
        this.orderId = reslut.data;
        // 路由跳转+路由传参
